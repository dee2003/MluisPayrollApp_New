...
//   try {
//     // ✅ Fetch active timesheet first
//     const timesheetRes = await apiClient.get(`/api/timesheets?foreman_id=${user?.id}`);
//     const activeTimesheet = timesheetRes.data?.[0];
...
//       Alert.alert('✅ Scan Successful', 'Ticket linked to your job successfully.');
//     } else {
//       Alert.alert('Scan Failed', 'The server could not process the image.');
//     }
//   } catch (err: any) {
//     console.error('Unexpected scan error:', err.response?.data || err.message);
