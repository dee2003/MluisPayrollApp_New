...
//   PETimesheetList: { foremanId: number; date: string; foremanName: string,supervisorName:string };
//   PETicketList: { foremanId: number; date: string; foremanName: string,supervisorName:string };
//   TimesheetReview: { timesheetId: number };
// };
