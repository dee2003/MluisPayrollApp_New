...
def update_material_trucking(id: int, update_data: schemas.MaterialTruckingUpdate, db: Session = Depends(database.get_db)):
    updated = crud.update_material_trucking(db, id, update_data)
    if not updated:
