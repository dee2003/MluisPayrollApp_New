...
router = APIRouter(prefix="/api/dumping-sites", tags=["Dumping Sites"])
...
def update_site(site_id: str, site: schemas.DumpingSiteCreate, db: Session = Depends(database.get_db)):
